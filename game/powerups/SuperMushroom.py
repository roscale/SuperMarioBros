...
class SuperMushroom(PowerUp):
	def init(self, *args, **kwargs):
		super().init()
		self.tags.append("SuperMushroom")

		spriteRenderer = self.getComponent(SpriteRenderer)
		spriteRenderer.setImage(Resources.theme[self.theme]["superMushroom"])
		...
		self.addScript(self.SuperMashroomScript)


	class SuperMashroomScript(Script):
